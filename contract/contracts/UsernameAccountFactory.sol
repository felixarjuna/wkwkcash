...
contract UsernameAccountFactory is BaseAccountFactory {
    ...
    function onRegistered(
        ...
        require(this.isRegistered(account), "CredentialAccountFactory: Account has not registered");
        require(accountOfUsername[username] == address(0), "CredentialAccountFactory: Username already exists.");
